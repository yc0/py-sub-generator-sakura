...
**針對 M1/M2/M3 Mac 最佳化**，顯著提升效能：

| 組件 | 效能提升 | 備註 |
|-----------|------------------|-------|
| ASR 處理 | 快 3-5 倍 | Whisper 模型的 MPS 加速 |
| 翻譯 | 快 2-4 倍 | ARM64 最佳化的 PyTorch 運算 |  
| 模型載入 | 快 50% | 使用 uv 最佳化依賴項 |
| 記憶體使用 | 減少 20-30% | 高效的 ARM64 原生庫 |

### Apple Silicon 特色：
- **🔥 MPS 加速**：使用 Apple 的 Metal Performance Shaders 自動 GPU 加速
- **⚡ ARM64 原生**：所有依賴項針對 Apple Silicon 架構最佳化  
- **💚 節能**：相較於 Intel Mac 功耗更低
- **🧠 統一記憶體**：有效利用 Apple 統一記憶體架構
