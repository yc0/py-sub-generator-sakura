...
class TestSakuraTranslator:
    ...
    def test_sakura_model_info(self):
        ...
        expected_keys = [
            ...
            "device", "dtype", "loaded", "specialization"
        ]
    ...
    def test_recommended_models(self):
        ...
        expected_categories = ["low_vram", "medium_vram", "high_vram", "maximum_quality"]
    ...
    def test_sakura_device_detection(self):
        ...
        assert translator.optimal_device in ["cpu", "mps", "cuda"] or translator.optimal_device.startswith("cuda")
...
class TestSakuraTranslationResults:
    ...
    def test_sakura_translation_result_format(self, mock_tokenizer_class, mock_model_class):
