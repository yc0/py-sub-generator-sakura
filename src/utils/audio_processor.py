...
class AudioProcessor:
    ...
    def extract_audio_from_video(self, video_file: VideoFile) -> Optional[AudioData]:
        ...
        try:
            ...
            (
                ffmpeg
                .input(str(video_file.file_path))
                .output(
                    temp_audio_path,
            ...
            logger.error("ffmpeg-python not installed. Please install it: pip install ffmpeg-python")
            return None
    ...
    def load_audio_file(self, audio_path: Path) -> Optional[AudioData]:
        ...
        try:
            ...
            logger.error("librosa not installed. Please install it: pip install librosa")
            return None
        except Exception as e:
    ...
    def split_audio_chunks(self, audio_data: AudioData, 
                          chunk_duration: float = 30.0,
                          overlap: float = 1.0) -> list[AudioData]:
